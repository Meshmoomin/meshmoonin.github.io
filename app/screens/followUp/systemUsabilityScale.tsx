...
export default function SystemUsabilityScale() {
  ...
  const susQuestions = [
    ...
    { id: 2, text: "Ich finde das System unnötig komplex." },
    { id: 3, text: "Ich finde das System einfach zu nutzen." },
    {
      id: 4,
    ...
    { id: 8, text: "Ich empfinde die Bedienung als sehr umständlich." },
    {
      id: 9,
